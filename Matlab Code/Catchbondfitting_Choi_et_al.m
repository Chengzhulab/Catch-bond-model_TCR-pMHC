...
if Modelselect == 1
    ...
    ub = [d_N 89.99 100 12]; % upper bound can be set by considering actual PDB structure and physical reasonability
elseif Modelselect  == 2
    % order of parameterizations : [d0 theta0 k0 delx0]
    lb = [7 0.01 0.01 0.01]; % Lower bound can be set by considering actual PDB structure and physical reasonability
    ub = [10 90 100 10]; % upper bound can be set by considering actual PDB structure and physical reasonability
