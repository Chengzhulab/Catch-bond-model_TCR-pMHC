...
% %  3. One can calculate error itself by Jacobian and residual matrix
...
%% Loading raw data
rawdata = dir('*.txt'); % One represented file was included (OT1 naive TCR:OVA:H2-Kd), the other data were also uploaded in different folder.
S = struct(rawdata);
numdata= size(S,1);
dataraw={};
