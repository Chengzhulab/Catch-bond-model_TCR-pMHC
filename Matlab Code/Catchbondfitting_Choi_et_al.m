...
% %    - One is from directly applying Eq.S6 (for both)in the manuscript
% %      (mathmatically, maximum bound of n*)
% %    - The other is from molecular extension without any partial unfolding (i.e., n* = 0/ related to Eq.S7 for class 1, Eq. S13)
